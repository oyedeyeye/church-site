        ...
        <div className="container mx-auto py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-5 bg-white rounded-lg">
              <h2 className="text-2xl font-semibold text-blue-900 mb-4">HISTORY OF THE CHURCH</h2>
            ...
            <div className="p-5 bg-white rounded-lg">
              <h2 className="text-2xl font-semibold text-blue-900 mb-4">THE SEVEN-FOLD COVENANT</h2>
              <h3 className="text-lg font-semibold text-blue-900 mb-2">God's covenant with the household of SEPCAM</h3>
