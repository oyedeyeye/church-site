      ...
      <div className="container py-4">
        ...
        <nav class="navbar navbar-light bg-transparent">
          <div class="container-fluid">
            ...
            <form class="d-flex">
              <span class="input-group-text bg-transparent brt">
                <img src="/logs/magnifyingglass.png" />
              </span>
              <input
                class="form-control me-2 rbt"
                type="search"
                placeholder="Search"
                aria-label="Search"
              />
              ...
              >
                <div className="grid p-4 bg-gray-100">
                  <img
                    ...
                    className="w-40 h-30 "
                  />
                  <h3 className="ml-3 mt-4 text-lg font-medium">
                    {message.theme}
                  </h3>
                </div>
                <div className="p-4" style={{ minHeight: "150px" }}>
                  <h5 className="font-bold">{message.title}</h5>
                  <p>{message.caption.replace(/\s+/g, " ").trim()}</p>
                  <p>{message.preacher}</p>
                  <div
